                ...
                <div className="col-12 col-lg-8 offset-0 offset-lg-2">
                    <div className="table-responsive">
                        <table className="table table-bordered">
                            <thead>
                                <tr><th>ID</th><th>Producto</th><th>Descripción</th><th>Estatus</th><th></th></tr>
                            </thead>
                            <tbody className="table-group-divider">
                                {entities.map((entity, i) => (
                                    <tr key={entity.id}>
                                        ...
                                        <td>{entity.status}</td>
                                        <td>
                                            <Link to={`/edit/${entity.id}`} className='btn btn-warning'>Editar</Link>
                                            &nbsp;
                                            <button className="btn btn-danger" onClick={() => deleteEntites(entity.id)}>Eliminar</button>
                                        </td>
                                    </tr>
                                ))
